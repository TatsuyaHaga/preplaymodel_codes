...
for t in range(simlen):
    ...
    dnd_input_current=dnd_input_current+time_pitch*(-dnd_input_current/tauL+dnd_mix@input_src+noise_amp*numpy.random.randn(dnd_input_num))

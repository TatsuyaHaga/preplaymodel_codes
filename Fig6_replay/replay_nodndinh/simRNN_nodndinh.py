...
#dendritic inhibition OFF
etaIdnd=0.0
WIEdnd=numpy.zeros_like(WIEdnd)
WEIdnd=numpy.zeros_like(WEIdnd)
...
numpy.savetxt("WIEsom_end.csv", WIEsom, delimiter=",")
numpy.savetxt("WIEdnd_end.csv", WIEdnd, delimiter=",")

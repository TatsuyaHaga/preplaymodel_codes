...
pylab.clf()
pylab.figure(figsize=(3,3.5))
pylab.subplot2grid([11,1],[0,0], rowspan=2)
...
pylab.subplot2grid([11,1],[2,0], rowspan=1)
pylab.plot(time, DG)
pylab.xticks([])
pylab.ylim([0,1])
pylab.yticks([])
...
pylab.subplot2grid([11,1],[3,0], rowspan=4)
...
pylab.ylabel("Inputs from EC")

pylab.subplot2grid([11,1],[7,0], rowspan=4)
